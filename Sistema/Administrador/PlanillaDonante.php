...
<tr style="background: #070707;background: -moz-linear-gradient(top, #262626 0%, #070707 100%);background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #262626), color-stop(100%, #070707));background: -webkit-linear-gradient(top, #262626 0%, #070707 100%);background: -o-linear-gradient(top, #262626 0%, #070707 100%);background: -ms-linear-gradient(top, #262626 0%, #070707 100%);background: linear-gradient(to bottom, #262626 0%, #070707 100%);" height="40"><td colspan="4" style="border-bottom:groove"><font size="5" color="#FFF"><center>Última Serología del Paciente</td></tr>
<tr>
...
<input type="button" name="btnregresar" value="             " class="regresar" id="btnimprimir" onClick="location.href='PlanillaABuscar.php'"> 
</td></tr></table> 
<?php 